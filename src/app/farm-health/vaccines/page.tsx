...
export default function VaccinesPage() {
  ...
  const saveVaccine = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const entered = form.dateEntered?.trim() || undefined;
      const row: Omit<Vaccine, "id"> = {
        ...
        qtyAvailable,
        costPrice,
        purchaseDate: entered,
        purchaseDateBs: entered ? adYmdToBsYmd(entered) : undefined,
        reDoseIntervalValue,
            ...
            <form onSubmit={saveVaccine} className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <div className="sm:col-span-2">
                <DualDateField
                  ...
                  onChange={(ad) => setForm({ ...form, dateEntered: ad })}
                />
              </div>
              <div>
