    ...
    <PageRoot>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <label htmlFor="loss-report-month" className="text-sm font-medium text-slate-600">
            Month
          </label>
          <input
            id="loss-report-month"
            name="lossReportMonth"
            type="month"
            value={month}
                  ...
                  .map((l) => (
                    <tr key={l.id}>
                      <td className="px-4 lg:px-6 py-4 text-sm text-slate-600">
                        <DualDateDisplay iso={l.date} dateBs={l.dateBs} />
                      </td>
