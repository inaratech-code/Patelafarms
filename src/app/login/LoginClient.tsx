  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        const canRecoverFromCloud =
          msg === "User not found" ||
          msg === "User has no password set" ||
          msg === "Incorrect password." ||
          msg === "Invalid password";
        if (!canRecoverFromCloud) throw err;
        ...
        if (bootstrap.reason === "farm_mismatch") {
          throw new Error(
            "This browser is already linked to a different farm. Use the existing farm account here, or reset this browser's app data before signing into another farm."
          );
        }
